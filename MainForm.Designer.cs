namespace PdfPageSaver
{
	partial class MainForm
	{
        ...
        "r the \'Save Settings\' is checkmarked.");
			...
			this.btnRemoveAll.Location = new System.Drawing.Point(434, 127);
    ...
    "7, 12-14, etc.";
			...
			this.toolTip1.SetToolTip(this.lblPageNumbers, "Contains the values corresponding to the page \r\nnumbers from each pdf file you wi" +
        "sh to save.");
			// 
			// listBox1
			// 
        ...
        "xt time this application is opened .");
			...
			this.toolTip1.SetToolTip(this.btnBrowseFiles, "Opens a file dialog allowing you to select \r\nthe files to add to the list of PDF " +
        "files.");
